"""
Execution Entry Point for Task 1 Part B — Experiment Group 3: RMSprop (LR=0.001).

Configuration:
- Model: Pure Baseline CNN via build_baseline_cnn() (2,658,122 parameters)
- Optimizer: RMSprop, learning_rate=0.001, rho=0.9, momentum=0.0, epsilon=1e-7
- Epochs: 30 (Fixed)
- Batch Size: 64
...
Usage:
    python Task_1_CNN/src/training/run_opt_rmsprop_lr_001.py
    python -m src.training.run_opt_rmsprop_lr_001
"""
...
if __name__ == "__main__":
    run_single_optimization_experiment("opt_rmsprop_lr_001")
