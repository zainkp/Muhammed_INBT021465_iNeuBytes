"""
Execution Entry Point for Task 1 Part B — Experiment Group 3: Adam (LR=0.001).
...
Usage:
    python Task_1_CNN/src/training/run_opt_adam_lr_001.py
    python -m src.training.run_opt_adam_lr_001
"""
...
if __name__ == "__main__":
    run_single_optimization_experiment("opt_adam_lr_001")
